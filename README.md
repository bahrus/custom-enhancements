...
A working polyfill of this proposal is available at [assign-gingerly](https://github.com/bahrus/assign-gingerly) (for the property assignment, dependency injection, and registry APIs) and [mount-observer](https://github.com/bahrus/mount-observer) (for automatic DOM discovery and enhancement attachment).  These polyfills ARE heavily influenced, and work best, within the current constraints of what is easily available to developers without excessively deep surgery, and could probably be streamlined when implementing directly in a browser setting.
